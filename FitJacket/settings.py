...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'FitJacket/static'),
]
...
ALLOWED_HOSTS = ['gtfitjacket.pythonanywhere.com', 'localhost', '127.0.0.1', '[::1]']
...
LOGIN_URL = 'users:login' # redirect to this if user logs into page that required login
